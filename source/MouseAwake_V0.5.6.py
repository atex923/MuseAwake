...
FULLSCREEN_EDGE_TOLERANCE_PX = 3
...
def rect_covers_monitor(
    window_rect: wintypes.RECT,
    monitor_rect: wintypes.RECT,
    tolerance: int = FULLSCREEN_EDGE_TOLERANCE_PX,
) -> bool:
    """判斷視窗矩形是否覆蓋整個螢幕。"""
...
class MouseAwakeApp:
    ...
    def update_status(self) -> None:
        ...
        try:
            ...
            foreground_fullscreen = is_foreground_window_fullscreen()
            ...
            if self.flame_test_mode:
                ...
                if (
                    ...
                    if (
                        not self.flame_active
                        and not foreground_fullscreen
                    ):
